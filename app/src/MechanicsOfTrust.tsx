                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center w-full">
                    <div className="space-y-8 z-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-light/10 dark:bg-white/5 rounded-full border border-primary-light/20 dark:border-white/10">
                            ...
                            <span className="text-xs font-mono font-medium text-primary-light dark:text-trust-blue uppercase tracking-wider">AI-Powered Protocol</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tighter-swiss text-text-body-light dark:text-white">
                            Natural Language <br /> to <span className="text-trust-blue">ZK Circuits.</span>
                        </h1>
                        <p className="text-lg md:text-xl text-text-muted leading-relaxed max-w-xl font-normal">
                            Tell Sentinel what you want to reveal. Our AI builds a custom Noir ZK circuit for any website or API instantly. No cryptography degree required.
                        </p>
                        <div className="flex flex-wrap gap-6 pt-4">
                            <div className="flex items-center gap-3">
                                <Zap className="text-trust-blue w-6 h-6" />
                                <span className="text-sm font-bold uppercase tracking-widest text-text-body-light dark:text-white/80">Instant Deployment</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <LayoutGrid className="text-trust-blue w-6 h-6" />
                                <span className="text-sm font-bold uppercase tracking-widest text-text-body-light dark:text-white/80">Global Library</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="max-w-3xl mb-20">
                        ...
                        <p className="text-lg text-text-muted leading-relaxed font-normal">
                            Sentinel verifyies the validity of your information without ever seeing the sensitive data itself. We see the "Envelope," never the "Letter."
                        </p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-surface-light dark:bg-surface-dark border border-grid-color dark:border-white/10 p-10 relative group hover:border-trust-blue/50 transition-colors shadow-sm">
                            ...
                            <h4 className="font-bold text-xl mb-3 text-text-body-light dark:text-white">Local Extraction</h4>
                            <p className="text-text-muted text-sm leading-relaxed font-normal">Data extraction happens entirely on your device. Your raw bank data never touches our servers.</p>
                        </div>
                        <div className="bg-primary-light dark:bg-trust-blue border border-primary-light dark:border-trust-blue p-10 relative shadow-2xl scale-105 z-10 text-white">
                            ...
                            <h4 className="font-bold text-xl mb-3">Ephemeral Notary</h4>
                            <p className="text-white/80 text-sm leading-relaxed font-normal">Our server acts as an MPC participant to verify the TLS certificate while the session is still encrypted.</p>
                        </div>
                        <div className="bg-surface-light dark:bg-surface-dark border border-grid-color dark:border-white/10 p-10 relative group hover:border-trust-blue/50 transition-colors shadow-sm">
                            <div className="w-12 h-12 bg-gray-50 dark:bg-white/5 flex items-center justify-center mb-8 text-green-500">
                                <CheckCircle className="w-6 h-6" />
                            </div>
                            <h4 className="font-bold text-xl mb-3 text-text-body-light dark:text-white">Verifiable Receipt</h4>
                            <p className="text-text-muted text-sm leading-relaxed font-normal">The result is a ZK-Proof link. The destination gets the "Yes" without the "What".</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 px-6 md:px-20 border-b border-grid-color dark:border-white/10 bg-grid-pattern-light dark:bg-grid-pattern-dark">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="order-1 lg:order-2 space-y-8">
                        ...
                        <h3 className="text-4xl font-bold tracking-tighter-swiss text-text-body-light dark:text-white">The Global Proof Library</h3>
                        <p className="text-lg text-text-muted leading-relaxed font-normal">
                            Sentinel grows with its users. Every time a new circuit is built for a specific bank or API, it becomes available for the entire network.
                        </p>
                        <ul className="space-y-5">
                            <li className="flex items-center gap-4 text-text-body-light dark:text-white/90">
                                ...
                                <span className="text-sm font-medium">Community-driven verification standards</span>
                            </li>
                            <li className="flex items-center gap-4 text-text-body-light dark:text-white/90">
                                <CheckCircle className="text-trust-blue w-5 h-5" />
                                <span className="text-sm font-medium">Reusable circuits for thousands of institutions</span>
                            </li>
                            <li className="flex items-center gap-4 text-text-body-light dark:text-white/90">
                                <CheckCircle className="text-trust-blue w-5 h-5" />
                                <span className="text-sm font-medium">Instant audit-readiness for any data source</span>
                            </li>
                        </ul>
                    </div>
                </div>
